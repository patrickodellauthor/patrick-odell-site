export const books = [
  {
    ...
    blurb: [
      'Supernatural detective and problem solver Elias Fetch has thought he’s lived and seen it all. But with grim news that the people of his hometown are dying, he embarks on a transformative journey to return to the small town of Locust Grove, Georgia—a place he thought he’d left in his rearview.',
    ...
    buyLinks: [
      ...
      { retailer: 'Books2Read', url: 'https://books2read.com/u/bzzZ9n' },
      { retailer: 'Goodreads', url: 'https://www.goodreads.com/book/show/243958513-gods-and-monsters' },
...

  {
    ...
    buyLinks: [
      { retailer: 'Amazon', url: 'https://www.amazon.com/gp/product/B0H844WRRF?ref_=dbs_m_mng_rwt_calw_tkin_1&storeType=ebooks' },
      { retailer: 'Goodreads', url: 'https://www.goodreads.com/book/show/247551899-watchers-in-the-dark' },
      { retailer: 'Bookshop.org', url: 'https://bookshop.org/p/books/watchers-in-the-dark-the-godfire-series-2-patrick-o-dell/0d94d37dd493439f' },
    ],
...

  {
    ...
    releaseDate: '2027-10-12',

    buyLinks: [
      { retailer: 'Goodreads', url: 'https://www.goodreads.com/book/show/247552095-the-dream-eater-s-bargain' },
      { retailer: 'Bookshop.org', url: 'https://bookshop.org/p/books/the-dream-eater-s-bargain-the-godfire-series-3-patrick-o-dell/13f0b72655584a52?ean=9798233432835&bkshp-astro=t' },
    ],
